...
namespace Unirgy\DropshipShippingClass\Model\ResourceModel\Vendor;
...
class Collection extends AbstractCollection
{
    ...
    {
        $this->_init('Unirgy\DropshipShippingClass\Model\Vendor',
                     'Unirgy\DropshipShippingClass\Model\ResourceModel\Vendor');
    }
    ...
    protected function _afterLoad()
    {
        ...
        $table = $this->getTable('udshipclass_vendor_row');
