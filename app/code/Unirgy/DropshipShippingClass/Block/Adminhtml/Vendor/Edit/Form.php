...
namespace Unirgy\DropshipShippingClass\Block\Adminhtml\Vendor\Edit;
...
class Form extends Generic
{
    ...
    {
        $model  = $this->_coreRegistry->registry('udshipclass_vendor');
        $form = $this->_formFactory->create(
            ['data' => ['id' => 'edit_form', 'action' => $this->getData('action'), 'method' => 'post']]
        );

        $this->setTitle(__('Vendor Ship Class Information'));

        $fieldset   = $form->addFieldset('base_fieldset', [
            'legend'    => __('Vendor Ship Class Information')
        ]);
