 ...
 */
class SimpleCondRates extends Widget implements RendererInterface
{
    /**
     * @var Layout
     */
    ...
    public function _construct()
    {
        parent::_construct();
        if (!$this->getTemplate()) {
            $this->setTemplate('Unirgy_DropshipTierShipping::udtiership/vendor/form/renderer/v2/simple_cond_rates.phtml');
        }
    }
    ...
    {
        return $this->getLayout()->getBlockSingleton('Unirgy\DropshipTierShipping\Block\Adminhtml\VendorEditTab\ShippingRates\V2\Renderer\SimpleCondRates\Subrows')
            ->setTemplate('Unirgy_DropshipTierShipping::udtiership/vendor/form/renderer/v2/simple_cond_rates/subrows.phtml')
