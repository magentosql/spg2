 ...
 */
class Rates extends Template implements RendererInterface
{
    /**
     * @var HelperData
     */
    ...
    public function __construct(
        ...
        if (!$this->getTemplate()) {
            $this->setTemplate('Unirgy_DropshipTierShipping::unirgy/tiership/vendor/v2/rates.phtml');
        }
    }
    ...
    {
        return $this->getLayout()->getBlockSingleton('Unirgy\DropshipTierShipping\Block\Vendor\V2\Rates\Subrows')
            ->setTemplate('Unirgy_DropshipTierShipping::unirgy/tiership/vendor/v2/rates/subrows.phtml')
