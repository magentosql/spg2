...
namespace Unirgy\Rma\Block\Adminhtml\SystemConfigFormField;

use Magento\Config\Block\System\Config\Form\Field;
use Magento\Framework\Data\Form\Element\AbstractElement;

class OptionsDefinition extends Field
{
    ...
    {
        parent::_construct();
        $this->setTemplate('Unirgy_Rma::urma/system/form_field/options_definition.phtml');
    }
